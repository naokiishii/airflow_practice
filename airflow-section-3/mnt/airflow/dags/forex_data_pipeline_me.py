...
run_this = download_rates()

def _get_message() -> str:
    return "Hi from forex_data_pipeline_me"

with DAG("forex_data_pipeline_me", start_date=datetime(2021, 1, 1), schedule_interval="@daily", default_args=default_args, catchup=False) as dag:

    is_forex_rates_available = HttpSensor(
        task_id="is_forex_rates_available",
        http_conn_id="forex_api_me",
